...
# AI 컴퓨팅 자원 지원 (aiinfrahub.kr)

## 🎯 주요 목적
- **[AI 연구 지원](ca://s?q=AI_연구_지원)**: 대학·연구기관의 대규모 AI 모델 학습 및 실험 지원  
- **[산업계 활용](ca://s?q=AI_산업계_GPU_활용)**: 스타트업·중소기업의 AI 서비스 개발 및 상용화 지원  
- **[GPUaaS 제공](ca://s?q=GPUaaS_서비스)**: 원격 접속 방식으로 GPU 서버를 클라우드처럼 활용 가능  

---

## 🖥️ GPU 서버 사양

| **[항목](ca://s?q=GPU_서버_항목)** | **[B200 Blackwell](ca://s?q=NVIDIA_B200_GPU_사양)** | **[H200 Hopper](ca://s?q=NVIDIA_H200_GPU_사양)** |
|---|---|---|
| **GPU** | 최대 8개 NVIDIA B200 Tensor Core | 최대 8개 NVIDIA H200 Tensor Core |
| **CPU** | 72코어 | 64코어 |
| **메모리** | 2,304GB | 2,048GB |
| **스토리지** | 서버당 2~30TB 공유 스토리지, NVMe 기반 로컬 46TB | 동일 |
| **네트워크** | 최대 400Gbps Infiniband | 최대 400Gbps Infiniband |
| **프레임워크 지원** | TensorFlow, PyTorch, Keras, Caffe, Theano | 동일 |
| **개발 도구** | JupyterLab, VSCode, Tmux | 동일 |

---

## ⚡ B200 vs H200 성능 차이
- **[성능](ca://s?q=B200_vs_H200_성능_차이)**: B200은 H200 대비 약 2.5배 높은 AI 연산 성능(FP4 기준 20 PFLOPS)  
- **[메모리](ca://s?q=B200_vs_H200_메모리_차이)**: B200은 192GB, H200은 141GB → B200이 더 큰 모델 처리 가능  
- **[냉각](ca://s?q=B200_vs_H200_냉각_차이)**: B200은 1000W TDP로 수랭 필수, H200은 700W로 공랭도 가능  
- **[가격](ca://s?q=B200_vs_H200_가격_차이)**: B200이 약 30% 더 비싸지만 성능 효율성 우수  
- **[적합 용도](ca://s?q=B200_vs_H200_적합_용도)**:  
  - H200 → 안정성·호환성이 중요하고 빠른 배포가 필요한 경우  
  - B200 → 초거대 멀티모달 모델, 차세대 AI 연구개발  

---

## 📑 신청 절차
1. **[공고 확인](ca://s?q=GPU_지원_공고_확인)**  
2. **[사업계획서 작성](ca://s?q=GPU_지원_사업계획서_작성)**  
3. **[온라인 접수](ca://s?q=GPU_지원_온라인_접수)**  
4. **[심사·선정](ca://s?q=GPU_지원_심사_선정)**  
5. **[GPU 활용](ca://s?q=GPU_지원_GPUaaS_활용)**  

---

## 💰 지원 대상 및 비용
- **학계·연구기관**: 무료 지원  
- **중소·중견기업·스타트업**: 민간 대비 5~10% 수준 비용  
- **청년기업(대표 만 39세 이하)**: 추가 50% 할인  

---

## 📞 문의처
- **한국정보통신진흥협회(KAIT)**  
  전화: [02-580-0213](tel:025800213)  
  이메일: gpu@kait.or.kr  
- **정보통신산업진흥원(NIPA)**  
