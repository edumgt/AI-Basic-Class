...
def run() -> dict:
    ...
    np.random.seed(42)
    # 설명: 값을 저장하거나 바꿔요.
    result = {"chapter": "chapter05", "topic": "선형회귀"}

    # 설명: 조건이 맞는지 확인해요.
    if "linear_regression" == "numpy":
        # 설명: 값을 저장하거나 바꿔요.
    ...
    # 설명: 앞 조건이 아니면 다른 조건을 확인해요.
    elif "linear_regression" == "probability":
        # 설명: 값을 저장하거나 바꿔요.
    ...
    # 설명: 앞 조건이 아니면 다른 조건을 확인해요.
    elif "linear_regression" == "linear_algebra":
        # 설명: 값을 저장하거나 바꿔요.
        A = np.array([[2, 1], [1, 3]])
        # 설명: 값을 저장하거나 바꿔요.
        b = np.array([1, 2])
    ...
    # 설명: 앞 조건이 아니면 다른 조건을 확인해요.
    elif "linear_regression" == "linear_regression":
        # 설명: 값을 저장하거나 바꿔요.
    ...
    # 설명: 앞 조건이 아니면 다른 조건을 확인해요.
    elif "linear_regression" == "logistic_regression":
        # 설명: 값을 저장하거나 바꿔요.
    ...
    # 설명: 앞 조건이 아니면 다른 조건을 확인해요.
    elif "linear_regression" == "decision_tree":
        # 설명: 값을 저장하거나 바꿔요.
    ...
    # 설명: 앞 조건이 아니면 다른 조건을 확인해요.
    elif "linear_regression" == "random_forest":
        # 설명: 값을 저장하거나 바꿔요.
    ...
    # 설명: 앞 조건이 아니면 다른 조건을 확인해요.
    elif "linear_regression" == "metrics":
        # 설명: 값을 저장하거나 바꿔요.
    ...
    # 설명: 앞 조건이 아니면 다른 조건을 확인해요.
    elif "linear_regression" == "validation":
        # 설명: 값을 저장하거나 바꿔요.
    ...
    # 설명: 앞 조건이 아니면 다른 조건을 확인해요.
    elif "linear_regression" == "feature_engineering":
        # 설명: 값을 저장하거나 바꿔요.
        df = pd.DataFrame({
            # 설명: 다음 코드를 실행해요.
            "age": [25, 30, 35, 40],
    ...
    # 설명: 앞 조건이 아니면 다른 조건을 확인해요.
    elif "linear_regression" == "regularization":
        # 설명: 값을 저장하거나 바꿔요.
    ...
    # 설명: 앞 조건이 아니면 다른 조건을 확인해요.
    elif "linear_regression" == "dimensionality_reduction":
        # 설명: 값을 저장하거나 바꿔요.
    ...
    # 설명: 앞 조건이 아니면 다른 조건을 확인해요.
    elif "linear_regression" == "outlier_detection":
        # 설명: 값을 저장하거나 바꿔요.
    ...
    # 설명: 앞 조건이 아니면 다른 조건을 확인해요.
    elif "linear_regression" == "time_series":
        # 설명: 값을 저장하거나 바꿔요.
    ...
    # 설명: 앞 조건이 아니면 다른 조건을 확인해요.
    elif "linear_regression" == "pipeline":
        # 설명: 값을 저장하거나 바꿔요.
        X, y = make_classification(n_samples=180, n_features=6, n_informative=4, random_state=42)
        # 설명: 값을 저장하거나 바꿔요.
        pipe = Pipeline([
    ...
    # 설명: 앞 조건이 아니면 다른 조건을 확인해요.
    elif "linear_regression" == "model_persistence":
        # 설명: 값을 저장하거나 바꿔요.
