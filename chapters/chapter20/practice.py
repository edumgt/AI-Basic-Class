...
def run() -> dict:
    np.random.seed(42)
    result = {"chapter": "chapter20", "topic": "미니 프로젝트 통합"}

    if "mini_project" == "numpy":
        arr = np.array([1, 2, 3, 4, 5])
        result["mean"] = float(arr.mean())
        result["std"] = float(arr.std())

    elif "mini_project" == "pandas":
    ...
    elif "mini_project" == "logistic_regression":
    ...
    elif "mini_project" == "decision_tree":
    ...
    elif "mini_project" == "random_forest":
    ...
    elif "mini_project" == "feature_engineering":
        df = pd.DataFrame({
            "age": [25, 30, 35, 40],
    ...
    elif "mini_project" == "regularization":
    ...
    elif "mini_project" == "dimensionality_reduction":
    ...
    elif "mini_project" == "outlier_detection":
    ...
    elif "mini_project" == "model_persistence":
