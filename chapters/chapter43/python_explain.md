...
### practice.py
- 이 파일은: 재현 가능한 실험 실습 파일
- 중요한 함수: `_run_model`, `run`
- 사용하는 도구: `__future__`, `numpy`, `sklearn.datasets`, `sklearn.ensemble`, `sklearn.metrics`, `sklearn.model_selection`
