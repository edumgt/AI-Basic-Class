...
def run() -> dict:
    np.random.seed(42)
    result = {"chapter": "chapter19", "topic": "FastAPI 서빙"}
    ...
    elif "serving" == "logistic_regression":
    ...
    elif "serving" == "feature_engineering":
        df = pd.DataFrame({
            "age": [25, 30, 35, 40],
    ...
    elif "serving" == "dimensionality_reduction":
    ...
    elif "serving" == "outlier_detection":
    ...
    elif "serving" == "model_persistence":
