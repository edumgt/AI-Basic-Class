...
### practice.py
- 이 파일은: 파이프라인 기초 실습 파일
- 중요한 함수: `run`
- 사용하는 도구: `__future__`, `sklearn.datasets`, `sklearn.linear_model`, `sklearn.metrics`, `sklearn.model_selection`, `sklearn.pipeline`, `sklearn.preprocessing`
