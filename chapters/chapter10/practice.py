...
def run() -> dict:
    ...
    np.random.seed(42)
    # 설명: 값을 저장하거나 바꿔요.
    result = {"chapter": "chapter10", "topic": "모델 평가 지표"}
    ...
    # 설명: 앞 조건이 아니면 다른 조건을 확인해요.
    elif "metrics" == "linear_regression":
        # 설명: 값을 저장하거나 바꿔요.
    ...
    # 설명: 앞 조건이 아니면 다른 조건을 확인해요.
    elif "metrics" == "logistic_regression":
        # 설명: 값을 저장하거나 바꿔요.
    ...
    # 설명: 앞 조건이 아니면 다른 조건을 확인해요.
    elif "metrics" == "feature_engineering":
        # 설명: 값을 저장하거나 바꿔요.
        df = pd.DataFrame({
            # 설명: 다음 코드를 실행해요.
            "age": [25, 30, 35, 40],
    ...
    # 설명: 앞 조건이 아니면 다른 조건을 확인해요.
    elif "metrics" == "dimensionality_reduction":
        # 설명: 값을 저장하거나 바꿔요.
    ...
    # 설명: 앞 조건이 아니면 다른 조건을 확인해요.
    elif "metrics" == "outlier_detection":
        # 설명: 값을 저장하거나 바꿔요.
    ...
    # 설명: 앞 조건이 아니면 다른 조건을 확인해요.
    elif "metrics" == "model_persistence":
        # 설명: 값을 저장하거나 바꿔요.
