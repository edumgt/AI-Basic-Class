...
def run() -> dict:
    ...
    np.random.seed(42)
    # 설명: 값을 저장하거나 바꿔요.
    result = {"chapter": "chapter11", "topic": "검증 전략"}
    ...
    # 설명: 앞 조건이 아니면 다른 조건을 확인해요.
    elif "validation" == "linear_algebra":
        # 설명: 값을 저장하거나 바꿔요.
        A = np.array([[2, 1], [1, 3]])
        # 설명: 값을 저장하거나 바꿔요.
        b = np.array([1, 2])
    ...
    # 설명: 앞 조건이 아니면 다른 조건을 확인해요.
    elif "validation" == "linear_regression":
        # 설명: 값을 저장하거나 바꿔요.
    ...
    # 설명: 앞 조건이 아니면 다른 조건을 확인해요.
    elif "validation" == "logistic_regression":
        # 설명: 값을 저장하거나 바꿔요.
    ...
    # 설명: 앞 조건이 아니면 다른 조건을 확인해요.
    elif "validation" == "feature_engineering":
        # 설명: 값을 저장하거나 바꿔요.
        df = pd.DataFrame({
            # 설명: 다음 코드를 실행해요.
            "age": [25, 30, 35, 40],
    ...
    # 설명: 앞 조건이 아니면 다른 조건을 확인해요.
    elif "validation" == "regularization":
        # 설명: 값을 저장하거나 바꿔요.
    ...
    # 설명: 앞 조건이 아니면 다른 조건을 확인해요.
    elif "validation" == "dimensionality_reduction":
        # 설명: 값을 저장하거나 바꿔요.
    ...
    # 설명: 앞 조건이 아니면 다른 조건을 확인해요.
    elif "validation" == "outlier_detection":
        # 설명: 값을 저장하거나 바꿔요.
    ...
    # 설명: 앞 조건이 아니면 다른 조건을 확인해요.
    elif "validation" == "model_persistence":
        # 설명: 값을 저장하거나 바꿔요.
