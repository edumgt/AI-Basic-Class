...
def run() -> dict:
    np.random.seed(42)
    result = {"chapter": "chapter01", "topic": "데이터와 NumPy 기초"}
    ...
    elif "numpy" == "logistic_regression":
    ...
    elif "numpy" == "feature_engineering":
        df = pd.DataFrame({
            "age": [25, 30, 35, 40],
    ...
    elif "numpy" == "dimensionality_reduction":
