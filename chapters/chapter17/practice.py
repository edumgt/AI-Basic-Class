...
def run() -> dict:
    np.random.seed(42)
    result = {"chapter": "chapter17", "topic": "파이프라인과 재현성"}
    ...
    elif "pipeline" == "logistic_regression":
    ...
    elif "pipeline" == "feature_engineering":
        df = pd.DataFrame({
            "age": [25, 30, 35, 40],
    ...
    elif "pipeline" == "dimensionality_reduction":
    ...
    elif "pipeline" == "outlier_detection":
    ...
    elif "pipeline" == "model_persistence":
